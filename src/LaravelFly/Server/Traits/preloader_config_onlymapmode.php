...
//    $basePath . '/vendor/symfony/http-foundation/Request.php',
    ...
    $basePath . '/vendor/october/rain/src/Database/DatabaseServiceProvider.php',
...
//    $basePath . '/vendor/laravel/framework/src/Illuminate/Http/Concerns/InteractsWithInput.php',
    ...
    // $basePath . '/vendor/october/rain/src/Html/Helper.php',
    // $basePath . '/vendor/october/rain/src/Extension/ExtendableTrait.php',
    // $basePath . '/vendor/october/rain/src/Extension/Extendable.php',
    // $basePath . '/vendor/october/rain/src/Extension/ExtensionTrait.php',
    // $basePath . '/vendor/october/rain/src/Extension/ExtensionBase.php',
    // $basePath . '/modules/system/traits/ViewMaker.php',
    // $basePath . '/modules/system/traits/AssetMaker.php',
    // $basePath . '/modules/system/traits/ConfigMaker.php',
    // $basePath . '/modules/system/traits/EventEmitter.php',
    // $basePath . '/modules/backend/traits/ErrorMaker.php',
    // $basePath . '/modules/backend/traits/WidgetMaker.php',
    // $basePath . '/modules/backend/traits/SessionMaker.php',
    // $basePath . '/modules/backend/traits/FormModelSaver.php',
    // $basePath . '/modules/backend/traits/SearchableWidget.php',
    // $basePath . '/modules/backend/classes/ControllerBehavior.php',
    // $basePath . '/modules/backend/classes/WidgetBase.php',
    // $basePath . '/modules/backend/classes/FilterScope.php',
    // $basePath . '/modules/backend/classes/FormField.php',
    // $basePath . '/modules/backend/classes/FormTabs.php',
    // $basePath . '/modules/backend/classes/FormWidgetBase.php',
    // $basePath . '/modules/backend/formwidgets/Relation.php',
    // $basePath . '/modules/backend/formwidgets/CodeEditor.php',
    // $basePath . '/modules/backend/widgets/Form.php',
    // $basePath . '/modules/backend/widgets/Filter.php',
    // $basePath . '/modules/backend/widgets/Search.php',
    // $basePath . '/vendor/october/rain/src/Support/helpers.php',
    // $basePath . '/vendor/october/rain/src/Html/helpers.php',
];
