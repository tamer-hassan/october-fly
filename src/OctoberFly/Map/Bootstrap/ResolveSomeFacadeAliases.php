...
class ResolveSomeFacadeAliases
{
     ...
     *
     * @param \OctoberFly\Map\Application $app
     * @return array
     */
    protected function getAliases(Application $app): array
    {
        ...
        if ($configCacheAlways && is_file($cacheFile)) {
             ...
             * @see:\OctoberFly\Map\Bootstrap\LoadConfiguration @unlink( $app->bootstrapPath('/cache/laravelfly_aliases.php'));
        ...
        if($configCacheAlways){
            ...
            \OctoberFly\Fly::getServer()->echo("cache created: $cacheFile");
