...
namespace OctoberFly;

use OctoberFly\Server\ServerInterface;
...
class Fly
{
    ...
    static function init(array $options, EventDispatcher $dispatcher = null): ServerInterface
    {
        ...
        $class = LARAVELFLY_MODE === 'FpmLike' ? \OctoberFly\Server\FpmHttpServer::class : $options['server'];

        if (!is_subclass_of($class, \OctoberFly\Server\ServerInterface::class))
